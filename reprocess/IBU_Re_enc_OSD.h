#pragma once
/*****************************************************************//**
 * \file   IBU_Re_enc_OSD.h
 * \brief  OSD utilizing IBU_Re_enc
 * 
 * \author 26259
 * \date   July 2024
 *********************************************************************/
...
#include"IBU_Re_enc.h"
#include"OSD.h"

 // to be optimized
class IBUc_Re_enc_OSD : public OSD_base {
protected:
	int n;
	int k;
...
public:
	...
	IBUc_Re_enc_OSD(const Matrix<GF2>& _G, int _min_Hamming_distance, \
		...
		if (is_cycle_used == true) {
			cout << "IBUc_Re_enc_OSD(" << _order << ")" << endl;
			type = 13;
		}
		else {
			cout << "IBU_Re_enc_OSD(" << _order << ")" << endl;
			type = 12;
		}
...
class IBUc_Re_enc_OSD_dual : public OSD_base {
protected:
	int n;
	int n_minus_k;
	int min_Hamming_distance;
...
public:
	...
	IBUc_Re_enc_OSD_dual(const Matrix<GF2>& _G, int _min_Hamming_distance, \
		...
		if (is_cycle_used == true) {
			cout << "IBUc_Re_enc_OSD_dual(" << _order << ")" << endl;
			type = 16;
		}
		else {
			cout << "IBU_Re_enc_OSD_dual(" << _order << ")" << endl;
			type = 15;
		}
